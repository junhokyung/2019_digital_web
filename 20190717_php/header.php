...
<head>
	...
	<style>
		*{padding: 0;margin:0;}
		...
		#sub02_content #sub02_section{width: 100%;height: 2000px;background-color: pink;}
		#sub03_content{width: 1200px;margin:0 auto;}
		#sub03_content #sub03_section{width: 100%;height: 2000px;background-color: brown;}
		#sub04_content{width: 1200px;margin:0 auto;}
		#sub04_content #sub04_section{width: 100%;height: 2000px;background-color: green;}
	</style>
</head>
<body>
